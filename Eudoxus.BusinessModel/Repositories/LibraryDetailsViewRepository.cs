...
{
    public class LibraryDetailsViewRepository : DomainRepository<HelpDeskViewsEntities, LibraryDetailsView, int>
    {
        #region [ Base .ctors ]

        public LibraryDetailsViewRepository() : base() { }

        public LibraryDetailsViewRepository(Imis.Domain.IUnitOfWork uow) : base(uow) { }

        #endregion

        public List<LibraryDetailsView> FindLibrariesWithCriteria(Criteria<LibraryDetailsView> criteria, out int totalRecordCount)
        {
            var query = BaseQuery;
