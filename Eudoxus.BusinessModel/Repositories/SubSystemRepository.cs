...
{
    public class SubSystemRepository : DomainRepository<HelpDeskEntities, SubSystem, int>
    {
        #region [ Base .ctors ]
        ...
        public List<SubSystem> FindSubSystems(Criteria<SubSystem> criteria, out int totalRecordCount)
        {
            var query = BaseQuery;
