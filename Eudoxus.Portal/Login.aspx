    ...
    <div class="login-cell2 cell2_box">
        ...
        <div class="cell2_content outer-content">
            <div class="middle-content">
                ...
                <br />
                <div class="buttonwrapper">
                    <a class="squarebutton" runat="server" href="~/Common/PublicationsOfficeRegistration.aspx">
                        <span>Γραφείο Διδακτικών Συγγραμμάτων Ιδρύματος</span></a>
                </div>
                <br />
                <div class="buttonwrapper">
                ...
                <br />
                <div class="buttonwrapper">
                    <a class="squarebutton" runat="server" href="~/Common/DistributionPointRegistration.aspx">
                        <span>Σημείο Διανομής</span></a>
                </div>
                <br />
                <div class="buttonwrapper">
                ...
                <br />
                <div class="buttonwrapper">
                    <a class="squarebutton" runat="server" href="~/Common/BookSupplierRegistration.aspx">
                        <span>Υπεύθυνος Παραγγελίας Βιβλίων</span></a>
                </div>
            </div>
        </div>
