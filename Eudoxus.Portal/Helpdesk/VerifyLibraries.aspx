<%@ Page Language="C#" MasterPageFile="~/Helpdesk/Helpdesk.Master" AutoEventWireup="true"
    Inherits="Eudoxus.Portal.Helpdesk.VerifyLibraries" Title="Πιστοποίηση Βιβλιοθηκών"
    CodeBehind="VerifyLibraries.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <table width="940px" class="dv">
        ...
        <tr>
            ...
            <td style="width: 300px">
                <asp:TextBox ID="txtLibraryName" runat="server" TabIndex="8" Width="100%" />
            </td>
        </tr>
        <tr>
            <th style="width: 100px">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <dxwgv:ASPxGridView ID="gvLibraries" runat="server" AutoGenerateColumns="False" DataSourceID="odsLibraries"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="ID Βιβλιοθήκης" HeaderStyle-HorizontalAlign="Center"
                        CellStyle-HorizontalAlign="Center">
                        <DataItemTemplate>
                            <%# Eval("ID") %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Στοιχεία Βιβλιοθήκης" CellStyle-HorizontalAlign="Left">
                        <DataItemTemplate>
                            <%# GetLibraryDetails((Library)Container.DataItem)%>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Επεξεργασία" HeaderStyle-Wrap="True" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <DataItemTemplate>
                            <a id="lnkViewAccountDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('ViewAccountDetails.aspx?rid={0}&t={1}', 'Στοιχεία Λογαριασμού');", Eval("ID"), (enReporterType.Library).ToString("D"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Πλήρη Στοιχεία" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkViewLibraryDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('VerifyLibrary.aspx?pID={0}','Προβολή Στοιχείων Βιβλιοθήκης',cmdRefresh);", Eval("ID"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Αλλαγή Στοιχείων" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkEditLibraryDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                visible='<%# (enVerificationStatus)Eval("VerificationStatus") == enVerificationStatus.Verified %>'
                                onclick=<%# string.Format("popUp.show('EditLibrary.aspx?pID={0}','Αλλαγή Στοιχείων Βιβλιοθήκης',cmdRefresh);", Eval("ID"))%>>
                                <img src="/_img/iconReportEdit.png" alt="Αλλαγή Στοιχείων Βιβλιοθήκης" />
                            </a>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
    ...
    <asp:ObjectDataSource ID="odsLibraries" runat="server" TypeName="Eudoxus.Portal.DataSources.Libraries"
        ...
        OnSelected="odsLibraries_Selected">
        <SelectParameters>
