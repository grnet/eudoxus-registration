<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="Eudoxus.Portal.Helpdesk.EditReporter"
    CodeBehind="EditReporter.aspx.cs" Title="Επεξεργασία Αναφέροντα" %>

<%@ Register Src="~/Helpdesk/UserControls/ReporterInput.ascx" TagName="ReporterInput"
    TagPrefix="my" %>
