<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="Eudoxus.Portal.Helpdesk.VerifyMinistryPaymentsUser"
    CodeBehind="VerifyMinistryPaymentsUser.aspx.cs" Title="Πιστοποίηση Χρήστη Υπουργείου - Πληρωμών" %>

<%@ Register Src="~/UserControls/MinistryPaymentsUserInput.ascx" TagName="MinistryPaymentsUserInput"
    TagPrefix="my" %>
        ...
        <tr>
            <td colspan="2" style="text-align: left; padding-left: 7px;">
                ...
                <asp:LinkButton ID="btnUnVerify" runat="server" Text="Από-Πιστοποίηση" CssClass="icon-btn bg-reject"
                    OnClick="btnUnVerify_Click" OnClientClick="return confirm('Θέλετε σίγουρα να από-πιστοποιήσετε το χρήστη;')" />
                <asp:LinkButton ID="btnReject" runat="server" Text="Απόρριψη" CssClass="icon-btn bg-reject"
                    OnClick="btnReject_Click" OnClientClick="return confirm('Θέλετε σίγουρα να απορρίψετε το χρήστη;')" />
                <asp:LinkButton ID="btnRestore" runat="server" Text="Επαναφορά" CssClass="icon-btn bg-undo"
                    OnClick="btnRestore_Click" OnClientClick="return confirm('Θέλετε σίγουρα να επαναφέρετε το χρήστη;')" />
    ...
    <script type="text/javascript">
        function accept() {
            if (Page_ClientValidate())
                return confirm('Θέλετε σίγουρα να πιστοποιήσετε το χρήστη;');
            else return false;
