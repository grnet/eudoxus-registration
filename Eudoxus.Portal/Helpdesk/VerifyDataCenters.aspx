<%@ Page Language="C#" MasterPageFile="~/Helpdesk/Helpdesk.Master" AutoEventWireup="true"
    Inherits="Eudoxus.Portal.Helpdesk.VerifyDataCenters" Title="Πιστοποίηση Γραφείων Μηχανογράφησης"
    CodeBehind="VerifyDataCenters.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <dxwgv:ASPxGridView ID="gvDataCenters" runat="server" AutoGenerateColumns="False"
                DataSourceID="odsDataCenters" KeyFieldName="ID" EnableRowsCache="false" EnableCallBacks="true"
                Width="100%" DataSourceForceStandardPaging="true" OnHtmlRowPrepared="gvDataCenters_HtmlRowPrepared">
                <SettingsLoadingPanel Text="Παρακαλώ Περιμένετε..." />
                <SettingsPager PageSize="10" Summary-Text="Σελίδα {0} από {1} ({2} Γραφεία Μηχανογράφησης)" Summary-Position="Left" />
                <Styles>
                    <Cell Font-Size="11px" />
                </Styles>
                <Templates>
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Στοιχεία Γραφείου" CellStyle-HorizontalAlign="Left">
                        <DataItemTemplate>
                            <%# GetDataCenterDetails((DataCenter)Container.DataItem)%>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Επεξεργασία" HeaderStyle-Wrap="True" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <DataItemTemplate>
                            <a id="lnkViewAccountDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('ViewAccountDetails.aspx?rid={0}&t={1}', 'Στοιχεία Λογαριασμού');", Eval("ID"), (enReporterType.DataCenter).ToString("D"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Πλήρη Στοιχεία" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkViewDataCenterDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('VerifyDataCenter.aspx?pID={0}','Προβολή Στοιχείων Γραφείου Μηχανογράφησης',cmdRefresh);", Eval("ID"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Αλλαγή Στοιχείων" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkEditDataCenterDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                visible='<%# (enVerificationStatus)Eval("VerificationStatus") == enVerificationStatus.Verified %>'
                                onclick=<%# string.Format("popUp.show('EditDataCenter.aspx?pID={0}','Αλλαγή Στοιχείων Γραφείου Μηχανογράφησης',cmdRefresh);", Eval("ID"))%>>
    ...
    <asp:ObjectDataSource ID="odsDataCenters" runat="server" TypeName="Eudoxus.Portal.DataSources.DataCenters"
        ...
        OnSelected="odsDataCenters_Selected">
        <SelectParameters>
