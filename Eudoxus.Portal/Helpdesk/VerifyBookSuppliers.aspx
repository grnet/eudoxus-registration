<%@ Page Language="C#" MasterPageFile="~/Helpdesk/Helpdesk.Master" AutoEventWireup="true"
    Inherits="Eudoxus.Portal.Helpdesk.VerifyBookSuppliers" Title="Πιστοποίηση Υπεύθυνων Παραγγελίας Βιβλίων"
    CodeBehind="VerifyBookSuppliers.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <dxwgv:ASPxGridView ID="gvBookSuppliers" runat="server" AutoGenerateColumns="False"
                DataSourceID="odsBookSuppliers" KeyFieldName="ID" EnableRowsCache="false" EnableCallBacks="true"
                Width="100%" DataSourceForceStandardPaging="true" OnHtmlRowPrepared="gvBookSuppliers_HtmlRowPrepared">
                <SettingsLoadingPanel Text="Παρακαλώ Περιμένετε..." />
                <SettingsPager PageSize="10" Summary-Text="Σελίδα {0} από {1} ({2} Υπεύθυνοι Παραγγελίας Βιβλίων)" Summary-Position="Left" />
                <Styles>
                    <Cell Font-Size="11px" />
                </Styles>
                <Templates>
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="ID Υπεύθυνου" HeaderStyle-HorizontalAlign="Center"
                        CellStyle-HorizontalAlign="Center">
                        <DataItemTemplate>
                            <%# Eval("ID") %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Στοιχεία Υπεύθυνου" CellStyle-HorizontalAlign="Left">
                        <DataItemTemplate>
                            <%# GetBookSupplierDetails((BookSupplier)Container.DataItem)%>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Επεξεργασία" HeaderStyle-Wrap="True" HeaderStyle-HorizontalAlign="Center"
                        ...
                        <DataItemTemplate>
                            <a id="lnkViewAccountDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('ViewAccountDetails.aspx?rid={0}&t={1}', 'Στοιχεία Λογαριασμού');", Eval("ID"), (enReporterType.BookSupplier).ToString("D"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Πλήρη Στοιχεία" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkViewBookSupplierDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                onclick=<%# string.Format("popUp.show('VerifyBookSupplier.aspx?pID={0}','Προβολή Στοιχείων Υπεύθυνου Παραγγελίας Βιβλίων',cmdRefresh);", Eval("ID"))%>>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Αλλαγή Στοιχείων" Width="100px">
                        ...
                        <CellStyle HorizontalAlign="Center" />
                        <DataItemTemplate>
                            <a id="lnkEditBookSupplierDetails" runat="server" style="text-decoration: none" href="javascript:void(0)"
                                visible='<%# (enVerificationStatus)Eval("VerificationStatus") == enVerificationStatus.Verified %>'
                                onclick=<%# string.Format("popUp.show('EditBookSupplier.aspx?pID={0}','Αλλαγή Στοιχείων Υπεύθυνου Παραγγελίας Βιβλίων',cmdRefresh);", Eval("ID"))%>>
                                <img src="/_img/iconReportEdit.png" alt="Αλλαγή Στοιχείων Υπεύθυνου Παραγγελίας Βιβλίων" />
                            </a>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
    ...
    <asp:ObjectDataSource ID="odsBookSuppliers" runat="server" TypeName="Eudoxus.Portal.DataSources.BookSuppliers"
        ...
        OnSelected="odsBookSuppliers_Selected">
        <SelectParameters>
