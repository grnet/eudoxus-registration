...
{
    public partial class VerifyPricingCommittee : BaseEntityPortalPage<PricingCommittee>
    {
        ...
        protected void btnVerify_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ir.IncidentTypeID = AutomaticIncidentTypes.PricingCommitteeVerification;
                ir.Reporter = Entity;
                ...
                {
                    MailSender.SendPricingCommitteeVerification(email, Entity.UserName);
                }
            }
            catch (Exception ex)
            {
