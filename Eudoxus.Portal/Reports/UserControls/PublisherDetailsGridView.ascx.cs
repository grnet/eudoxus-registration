...
{
    public partial class PublisherDetailsGridView : System.Web.UI.UserControl
    {
        #region [ Events ]
        ...
        protected string GetAddressDetails(object o)
        {
            ...
            secretaryDetails = string.Format("{0}<br/>{1}<br/>{2}<br/>", secretary.SecretaryAddress, secretary.SecretaryZipCode, city, prefecture);
