<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SecretaryDetailsGridView.ascx.cs"
    Inherits="Eudoxus.Portal.Reports.UserControls.SecretaryDetailsGridView" %>
    ...
    <dxwgv:ASPxGridView ID="gvSecretariesExport" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataDateColumn FieldName="VerificationDate" Caption="Ημ/νία Πιστοποίησης"
                PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy" />
            <dxwgv:GridViewDataTextColumn FieldName="ID" Caption="SecretaryID" />
            <dxwgv:GridViewDataTextColumn FieldName="SecretaryAcademicID" Caption="MineduID" />
            ...
            <dxwgv:GridViewDataTextColumn FieldName="Semesters" Caption="Εξάμηνα Σπουδών" />
