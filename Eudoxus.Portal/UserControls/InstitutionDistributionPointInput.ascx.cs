...
{
    public partial class InstitutionDistributionPointInput : BaseEntityUserControl<DistributionPoint, BaseEntityPortalPage<DistributionPoint>>
    {
        ...
        public override void Bind()
        {
            ...
            {
                lblInstitution.Text = CacheManager.Institutions.Get((int)Entity.InstitutionID).Name;
                return;
            }
