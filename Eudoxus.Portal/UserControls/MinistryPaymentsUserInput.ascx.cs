...
{
    public partial class MinistryPaymentsUserInput : BaseEntityUserControl<MinistryPaymentsUser, BaseEntityPortalPage<MinistryPaymentsUser>>
    {
        #region [ Databind Methods ]

        public override MinistryPaymentsUser Fill(MinistryPaymentsUser entity)
        {
            if (entity == null)
                entity = new MinistryPaymentsUser();
            ...
            if (entity.Description != txtDescription.Text.ToNull())
