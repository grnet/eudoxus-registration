<%@ Control Language="C#" AutoEventWireup="true" Inherits="Eudoxus.Portal.UserControls.PricingCommitteeInput"
    CodeBehind="PricingCommitteeInput.ascx.cs" %>
...
<table width="100%" class="dv">
    ...
    <tr>
        <th colspan="2" class="header">
            &raquo; Στοιχεία Μέλους Επιτροπής
        </th>
    </tr>
    <tr>
        <th>
            Ονοματεπώνυμο:
            <my:TipIcon ID="tipContactName" runat="server" Text="<%$ Resources:PricingCommitteeInput, ContactName %>" />
        </th>
        <td>
    ...
    <tr>
        <th>
            Τηλέφωνο (σταθερό):
            <my:TipIcon ID="tipContactPhone" runat="server" Text="<%$ Resources:PricingCommitteeInput, ContactPhone %>" />
        </th>
        <td>
    ...
    <tr>
        <th>
            E-mail:
            <my:TipIcon ID="tipContactEmail" runat="server" Text="<%$ Resources:PricingCommitteeInput, ContactEmail %>" />
        </th>
        <td>
    ...
    <tr>
        <th>
            Ιδιότητα:
            <my:TipIcon ID="tipPricingCommitteeType" runat="server" Text="<%$ Resources:PricingCommitteeInput, PricingCommitteeType %>" />
        </th>
        <td>
            <asp:TextBox CssClass="source t2" ID="txtPricingCommitteeType" runat="server" MaxLength="100" Width="90%" />
        </td>
    </tr>
</table>
