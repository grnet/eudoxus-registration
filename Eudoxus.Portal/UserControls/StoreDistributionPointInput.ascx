<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StoreDistributionPointInput.ascx.cs"
    Inherits="Eudoxus.Portal.UserControls.StoreDistributionPointInput" %>
