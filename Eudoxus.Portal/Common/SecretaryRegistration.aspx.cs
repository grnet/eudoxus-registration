...
{
    public partial class SecretaryRegistration : BaseEntityPortalPage<Secretary>
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!Config.SecretaryRegistrationAllowed)
                mvRegistration.ActiveViewIndex = 2;

            base.OnLoad(e);
        }

        //protected void cbxAcceptTerms_Validate(object source, ServerValidateEventArgs args)
        //{
        //    args.IsValid = cbxAcceptTerms.Checked;
        //}
