...
{
    public partial class EbookPublisherRegistration : BaseEntityPortalPage<Publisher>
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            publisherType = enPublisherType.EbookPublisher;
            publisherInput.PublisherType = publisherType;
            publisherInput.IsForeignPublisher = false;

            lblTitle.Text = "Δημιουργία Χρήστη Διαθέτη Δωρεάν Ηλεκτρονικών Βοηθημάτων και Σημειώσεων";
            Title = "Δημιουργία Χρήστη Διαθέτη Δωρεάν Ηλεκτρονικών Βοηθημάτων και Σημειώσεων";
        }
