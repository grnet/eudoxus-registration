...
{
    public partial class ForeignPublisherRegistration : BaseEntityPortalPage<Publisher>
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            publisherType = enPublisherType.LegalPerson;
            publisherInput.PublisherType = publisherType;
            publisherInput.IsForeignPublisher = true;
