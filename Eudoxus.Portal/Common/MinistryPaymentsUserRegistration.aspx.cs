...
{
    public partial class MinistryPaymentsUserRegistration : BaseEntityPortalPage<MinistryPaymentsUser>
    {
        ...
        {
            ucMinistryPaymentsUserInputInput.Entity = Entity;
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            ucMinistryPaymentsUserInputInput.Fill();
            Entity.UserName = registerUserInput.Username;
            Entity.Email = registerUserInput.Email;
            Entity.MinistryAuthorization = enMinistryAuthorization.None;
