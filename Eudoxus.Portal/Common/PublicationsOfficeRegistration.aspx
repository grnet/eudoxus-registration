<%@ Page Title="" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="PublicationsOfficeRegistration.aspx.cs"
    Inherits="Eudoxus.Portal.Common.PublicationsOfficeRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">    
    ...
    <h1>
        <asp:Label ID="lblTitle" runat="server" Text="Δημιουργία Χρήστη Γραφείου Διδακτικών Συγγραμμάτων Ιδρύματος" Font-Size="14pt" />
    </h1>
    <asp:MultiView ID="mvRegistration" runat="server" ActiveViewIndex="0">
        <asp:View ID="vRegister" runat="server">
            ...
            <br />
            <my:PublicationsOfficeInput ID="ucPublicationsOfficeInput" runat="server" ValidationGroup="vdRegistration" />
            <br />
