<%@ Page Title="" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true"
    CodeBehind="BookSupplierRegistration.aspx.cs" Inherits="Eudoxus.Portal.Common.BookSupplierRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <h1>
        <asp:Label ID="lblTitle" runat="server" Text="Δημιουργία Χρήστη Υπεύθυνου Παραγγελίας Βιβλίων"
            Font-Size="14pt" />
    </h1>
    <asp:MultiView ID="mvRegistration" runat="server" ActiveViewIndex="0">
        <asp:View ID="vRegister" runat="server">
            ...
            <br />
            <my:BookSupplierInput ID="ucBookSupplierInput" runat="server" ValidationGroup="vdRegistration" />
            <br />
