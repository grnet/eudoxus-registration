<%@ Page Title="" Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="DistributionPointRegistration.aspx.cs"
    Inherits="Eudoxus.Portal.Common.DistributionPointRegistration" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">    
    ...
    <h1>
        <asp:Label ID="lblTitle" runat="server" Text="Δημιουργία Χρήστη Σημείου Διανομής" Font-Size="14pt" />
    </h1>
