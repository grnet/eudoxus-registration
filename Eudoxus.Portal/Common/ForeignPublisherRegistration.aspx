<%@ Page Language="C#" MasterPageFile="~/Portal.Master" AutoEventWireup="true" CodeBehind="ForeignPublisherRegistration.aspx.cs"
    Inherits="Eudoxus.Portal.Common.ForeignPublisherRegistration" Title="Δημιουργία Λογαριασμού" %>
        ...
        <asp:View ID="vRegister" runat="server">
            ...
            <div style="clear: both; text-align: left">
                <asp:LinkButton ID="btnCreate" runat="server" Text="Δημιουργία Λογαριασμού" CssClass="icon-btn bg-accept"
                    ValidationGroup="vdRegistration" OnClick="btnCreate_Click" OnClientClick="return validate()" />
            </div>
        </asp:View>
