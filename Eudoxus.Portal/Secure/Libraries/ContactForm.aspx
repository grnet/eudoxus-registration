<%@ Page Language="C#" MasterPageFile="~/PopUp.Master" AutoEventWireup="true" Inherits="Eudoxus.Portal.Secure.Libraries.ContactForm"
    CodeBehind="ContactForm.aspx.cs" Title="Ερώτημα προς Γραφείο Αρωγής" %>

<%@ Register Src="~/Secure/UserControls/ContactFormInput.ascx" TagName="ContactFormInput" TagPrefix="my" %>
