<%@ Page Language="C#" MasterPageFile="~/Secure/PublicationsOffices/PublicationsOffices.Master" AutoEventWireup="true" CodeBehind="PublicationsOfficeDetails.aspx.cs"
    Inherits="Eudoxus.Portal.Secure.PublicationsOffices.PublicationsOfficeDetails" Title="Διαχείριση Λογαριασμού" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="tabs" runat="server">
        <ajaxToolkit:TabPanel ID="tabPublicationsOffice" runat="server" HeaderText="Στοιχεία Γραφείου">
            <ContentTemplate>
                <asp:ValidationSummary ID="vdPublicationsOffice" runat="server" ValidationGroup="vgPublicationsOffice" />
                <br />
                <my:PublicationsOfficeInput ID="publicationsOfficeInput" runat="server" ValidationGroup="vgPublicationsOffice" />
                <br />
                <asp:LinkButton ID="btnUpdatePublicationsOffice" runat="server" Text="Ενημέρωση Στοιχείων Γραφείου" CssClass="icon-btn bg-accept" ValidationGroup="vgPublicationsOffice"
                    OnClick="btnUpdatePublicationsOffice_Click" OnClientClick="if (validate('vgPublicationsOffice')) { return confirm('Ο λογαριασμός σας δεν έχει ακόμα πιστοποιηθεί και για αυτό το λόγο μπορείτε να επεξεργαστείτε τα στοιχεία του.\n\nΕάν έχετε ήδη αποστείλει Fax στο Γραφείο Αρωγής, τότε οποιαδήποτε αλλαγή κάνετε θα έχει ως αποτέλεσμα να μην πιστοποιηθείτε, αφού τα στοιχεία του Fax θα διαφέρουν από αυτά του λογαριασμού σας.\n\nΓια το λόγο αυτό, θα πρέπει να στείλετε εκ νέου το Fax με τα νέα στοιχεία στο Γραφείο Αρωγής.\n\nΘέλετε όντως να παραγματοποιήσετε τις αλλαγές;'); } else { return false; }" />
            </ContentTemplate>
