<%@ Page Language="C#" MasterPageFile="~/Secure/DataCenters/DataCenters.Master" AutoEventWireup="true"
    CodeBehind="Default.aspx.cs" Inherits="Eudoxus.Portal.Secure.DataCenters.Default" Title="Κεντρική Σελίδα" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <asp:PlaceHolder ID="phNotVerified" runat="server">
        ...
        <p>
            Μέχρι να ολοκληρωθεί η πιστοποίηση του λογαριασμού σας έχετε τη δυνατότητα να επεξεργαστείτε τα στοιχεία που δηλώσατε κατά την εγγραφή σας στο σύστημα, μέσα από την καρτέλα <asp:HyperLink runat="server" NavigateUrl="~/Secure/DataCenters/DataCenterDetails.aspx"
        ...
        <asp:HyperLink runat="server" CssClass="icon-btn bg-print"
            Text="Εκτύπωση Βεβαίωσης Συμμετοχής" Target="_blank" NavigateUrl="~/Secure/DataCenters/PrintDataCenterCertification.aspx" />
    </asp:PlaceHolder>
    <asp:PlaceHolder ID="phVerified" runat="server">
        ...
        <ul>
            ...
            <li>Να επεξεργαστείτε τα στοιχεία που δηλώσατε κατά την εγγραφή σας στο σύστημα, μέσα
                από την καρτέλα <asp:HyperLink runat="server" NavigateUrl="~/Secure/DataCenters/DataCenterDetails.aspx"
