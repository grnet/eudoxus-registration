<%@ Page Language="C#" MasterPageFile="~/Secure/DataCenters/DataCenters.Master" AutoEventWireup="true" CodeBehind="DataCenterDetails.aspx.cs"
    Inherits="Eudoxus.Portal.Secure.DataCenters.DataCenterDetails" Title="Διαχείριση Λογαριασμού" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <ajaxToolkit:TabContainer ID="tabs" runat="server">
        <ajaxToolkit:TabPanel ID="tabDataCenter" runat="server" HeaderText="Στοιχεία Γραφείου">
            <ContentTemplate>
                <asp:ValidationSummary ID="vdDataCenter" runat="server" ValidationGroup="vgDataCenter" />
                <br />
                <my:DataCenterInput ID="dataCenterInput" runat="server" ValidationGroup="vgDataCenter" />
                <br />
                <asp:LinkButton ID="btnUpdateDataCenter" runat="server" Text="Ενημέρωση Στοιχείων Γραφείου" CssClass="icon-btn bg-accept" ValidationGroup="vgDataCenter"
                    OnClick="btnUpdateDataCenter_Click" OnClientClick="if (validate('vgDataCenter')) { return confirm('Ο λογαριασμός σας δεν έχει ακόμα πιστοποιηθεί και για αυτό το λόγο μπορείτε να επεξεργαστείτε τα στοιχεία του.\n\nΕάν έχετε ήδη αποστείλει Fax στο Γραφείο Αρωγής, τότε οποιαδήποτε αλλαγή κάνετε θα έχει ως αποτέλεσμα να μην πιστοποιηθείτε, αφού τα στοιχεία του Fax θα διαφέρουν από αυτά του λογαριασμού σας.\n\nΓια το λόγο αυτό, θα πρέπει να στείλετε εκ νέου το Fax με τα νέα στοιχεία στο Γραφείο Αρωγής.\n\nΘέλετε όντως να παραγματοποιήσετε τις αλλαγές;'); } else { return false; }" />
            </ContentTemplate>
