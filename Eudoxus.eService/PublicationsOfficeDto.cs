...
namespace Eudoxus.eService
{
    ...
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "", IsNullable = false, ElementName = "PublicationsOffice")]
    public class PublicationsOfficeDto
    {
        private int institutionIdField;

        private string directorNameField;

        private string publicationsOfficePhoneField;

        private string publicationsOfficeEmailField;

        private string publicationsOfficeAddressField;

        private string publicationsOfficeZipCodeField;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string PublicationsOfficePhone
        {
            get
            {
                return this.publicationsOfficePhoneField;
            }
            set
            {
                this.publicationsOfficePhoneField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string PublicationsOfficeEmail
        {
            get
            {
                return this.publicationsOfficeEmailField;
            }
            set
            {
                this.publicationsOfficeEmailField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string PublicationsOfficeAddress
        {
            get
            {
                return this.publicationsOfficeAddressField;
            }
            set
            {
                this.publicationsOfficeAddressField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string PublicationsOfficeZipCode
        {
            get
            {
                return this.publicationsOfficeZipCodeField;
            }
            set
            {
                this.publicationsOfficeZipCodeField = value;
            }
        }
