...
namespace Eudoxus.eService
{
    ...
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "", IsNullable = false, ElementName = "BookSupplier")]
    public class BookSupplierDto
    {
        private int institutionIdField;

        private int certifierTypeField;

        private string certifierNameField;

        private string bookSupplierAddressField;

        private string bookSupplierZipCodeField;
        ...
        public int CertifierType
        {
            get
            {
                return this.certifierTypeField;
            }
            set
            {
                this.certifierTypeField = value;
            }
        }
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string BookSupplierAddress
        {
            get
            {
                return this.bookSupplierAddressField;
            }
            set
            {
                this.bookSupplierAddressField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string BookSupplierZipCode
        {
            get
            {
                return this.bookSupplierZipCodeField;
            }
            set
            {
                this.bookSupplierZipCodeField = value;
            }
        }
